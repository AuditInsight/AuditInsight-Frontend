...
export default function AddTransactionModal({ open, createdBy, organisationId, onClose, onSubmit }: Props) {
  ...
  const reset = () => {
    ...
    setAmount(""); setCurrency("RWF"); setPaymentMethod("BANK");
    setType("EXPENSE"); setError("");
  };
...
const s: Record<string, React.CSSProperties> = {
  ...
  row:       { display: "flex", gap: 14, marginBottom: 0 },
