    ...
    <section id="features" style={s.section}>
      <style>{`
        ...
        @media (max-width: 960px) {
          ...
          .feat-head { font-size: 32px; }
        }
        @media (max-width: 600px) {
          .feat-grid { grid-template-columns: 1fr; }
          .feat-head { font-size: 26px; }
        }
      `}</style>
      <div style={s.inner}>
        <div style={s.head}>
...
const s: Record<string, React.CSSProperties> = {
  ...
  title:   { margin: "0 0 14px", fontWeight: 800, color: "#0f172a", letterSpacing: "-1px" },
  sub:     { margin: "0 auto", fontSize: 17, color: "#64748b", lineHeight: 1.6, maxWidth: 600 },
  card: {
  ...
  iconBox:   { width: 48, height: 48, borderRadius: 14, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 },
