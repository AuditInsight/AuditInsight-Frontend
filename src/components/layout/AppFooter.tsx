  ...
  return (
    <footer style={s.footer}>
      <div style={s.inner} className="footer-inner-responsive">
        ...
        <div style={s.right} className="footer-links-responsive">
        ...
        <div style={s.badges} className="footer-badges-responsive">
...
const s: Record<string, React.CSSProperties> = {
  footer: { borderTop: "1px solid #e2e8f0", background: "#fff", marginTop: "auto" },
  inner: {
